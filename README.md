...
Эксперимент по созданию фронтенда на React с использованием инструментов искусственного интеллекта (не через агенты, а просто через бесплатный https://copilot.microsoft.com). Компоненты формировались поэтапно на основе заданных условий, с частичным ручным редактированием.
